...
class DiggersbyModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame {
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("diggersby", "faint") else null
}