...
class GimmighoulRoamingModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override fun registerPoses() {
        val blink = quirk("blink") { bedrockStateful("gimmighoul_roaming", "blink").setPreventsIdle(false) }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("gimmighoul_roaming", "faint") else null
}