...
class FletchinderModel (root: ModelPart) : PosableModel(), HeadedFrame, BipedFrame, BiWingedFrame {
    ...
    override val cryAnimation = CryProvider { bedrockStateful("fletchinder", "cry") }
...
//        )
        ...
        stand = registerPose(
            ...
            idleAnimations = arrayOf(
                singleBoneLook(),
                bedrock("fletchinder", "ground_idle")
            )
        )
