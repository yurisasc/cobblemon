...
class BunnelbyModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame {
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("bunnelby", "faint") else null
}