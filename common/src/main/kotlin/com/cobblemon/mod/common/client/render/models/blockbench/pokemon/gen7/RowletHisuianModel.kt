...
class RowletHisuianModel(root: ModelPart) : PokemonPoseableModel(), BipedFrame, BiWingedFrame {
    override val rootPart = root.registerChildWithAllChildren("rowlet_hisuian")
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("rowlet_hisuian", "cry") }

    override fun registerPoses() {
        val blink = quirk { bedrockStateful("rowlet_hisuian", "blink") }
        standing = registerPose(
                ...
                idleAnimations = arrayOf(
                        bedrock("rowlet_hisuian", "ground_idle")
                )
        )
        ...
        flyidle = registerPose(
                ...
                idleAnimations = arrayOf(
                        bedrock("rowlet_hisuian", "flying_idle"),
        ...
        walk = registerPose(
                ...
                idleAnimations = arrayOf(
                        ...
                        //bedrock("rowlet_hisuian", "ground_walk")
                )
        )
    }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("rowlet_hisuian", "faint") else null
}