...
class MakuhitaModel (root: ModelPart) : PosableModel(root), HeadedFrame, BipedFrame, BimanualFrame {
...
//    override val cryAnimation = CryProvider { bedrockStateful("makuhita", "cry") }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("makuhita", "faint") else null
}