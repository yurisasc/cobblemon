...
class PachirisuModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame {
    ...
    override fun registerPoses() {
        val blink = quirk("blink") { bedrockStateful("pachirisu", "blink").setPreventsIdle(false) }
