...
class PhantumpModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("phantump", "faint") else null
}