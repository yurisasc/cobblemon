...
import com.cobblemon.mod.common.client.gui.summary.widgets.pages.moves.SwitchMoveButton.Companion.SWITCH_MOVE_BUTTON_HEIGHT
import com.cobblemon.mod.common.client.gui.summary.widgets.pages.moves.SwitchMoveButton.Companion.SWITCH_MOVE_BUTTON_WIDTH
...
class MoveWidget(
    ...
    companion object {
        private val moveResource = cobblemonResource("ui/summary/summary_moves_slot.png")
        private val moveOverlayResource = cobblemonResource("ui/summary/summary_moves_slot_overlay.png")
        private val movePpResource = cobblemonResource("ui/summary/summary_moves_overlay_pp.png")
