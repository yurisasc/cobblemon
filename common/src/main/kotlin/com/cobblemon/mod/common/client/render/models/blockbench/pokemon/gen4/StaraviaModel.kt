...
class StaraviaModel (root: ModelPart) : PokemonPosableModel(root), HeadedFrame, BipedFrame, BiWingedFrame {
...
//    override val cryAnimation = CryProvider { bedrockStateful("staravia", "cry") }
