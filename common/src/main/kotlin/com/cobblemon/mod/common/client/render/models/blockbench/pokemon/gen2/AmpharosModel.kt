...
class AmpharosModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("ampharos", "faint") else null
}