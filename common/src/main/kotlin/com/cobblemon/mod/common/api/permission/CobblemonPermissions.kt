...
object CobblemonPermissions {
    ...
    val GIVE_POKEMON_OTHER = this.create("${GIVE_POKEMON_BASE}.other", PermissionLevel.MULTIPLAYER_MANAGEMENT)
    ...
    val HEAL_POKEMON_OTHER = this.create("$HEAL_POKEMON_BASE.other", PermissionLevel.MULTIPLAYER_MANAGEMENT)
    ...
    val LEVEL_UP_OTHER = this.create("$LEVEL_UP_BASE.other", PermissionLevel.MULTIPLAYER_MANAGEMENT)

    val OPEN_STARTER_SCREEN = this.create("${COMMAND_PREFIX}openstarterscreen", PermissionLevel.MULTIPLAYER_MANAGEMENT)
    ...
    val POKEMON_EDIT_OTHER = this.create("$POKEMON_EDIT_BASE.other", PermissionLevel.MULTIPLAYER_MANAGEMENT)
    ...
    val STOP_BATTLE = this.create("${COMMAND_PREFIX}stopbattle", PermissionLevel.MULTIPLAYER_MANAGEMENT)

    val TAKE_POKEMON = this.create("${COMMAND_PREFIX}takepokemon", PermissionLevel.MULTIPLAYER_MANAGEMENT)
