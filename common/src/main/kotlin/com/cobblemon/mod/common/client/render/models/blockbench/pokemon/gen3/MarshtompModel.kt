...
class MarshtompModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame, BipedFrame {
    ...
    override val cryAnimation = CryProvider { bedrockStateful("marshtomp", "cry") }

    override fun registerPoses() {
        val blink = quirk { bedrockStateful("marshtomp", "blink") }
