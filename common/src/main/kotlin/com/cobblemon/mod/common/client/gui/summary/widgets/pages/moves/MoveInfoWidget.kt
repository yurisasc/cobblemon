...
class MoveInfoWidget(
    ...
    companion object {
        private val powerText = Text.translatable("cobblemon.ui.power")
        private val accuracyText = Text.translatable("cobblemon.ui.accuracy")
        private val effectText = Text.translatable("cobblemon.ui.effect")
