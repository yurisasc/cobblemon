...
class BouffalantModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame {
    override val rootPart = root.registerChildWithAllChildren("bouffalant")
    override val head = getPart("head")

    override var portraitScale = 1.9F
    override var portraitTranslation = Vec3d(-0.9, -0.7, 0.0)
    ...
    override val cryAnimation = CryProvider { bedrockStateful("bouffalant", "cry") }
