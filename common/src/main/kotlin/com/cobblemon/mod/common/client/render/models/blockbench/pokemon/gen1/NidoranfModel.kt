...
class NidoranfModel(root: ModelPart) : PosableModel(), HeadedFrame {
    ...
    override fun registerPoses() {
        sleep = registerPose(
                ...
                idleAnimations = arrayOf(bedrock("nidoranf", "sleep"))
        )
