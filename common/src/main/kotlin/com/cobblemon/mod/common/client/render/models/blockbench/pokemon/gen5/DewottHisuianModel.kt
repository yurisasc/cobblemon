...
class DewottHisuianModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
    override val rootPart = root.registerChildWithAllChildren("dewott_hisui")
    ...
    override fun registerPoses() {
        val blink = quirk { bedrockStateful("dewott_hisuian", "blink") }
        //sleep = registerPose(
...
//
        //        ),
        //        idleAnimations = arrayOf(bedrock("dewott_hisuian", "sleep"))
        //)
