...
class BoltundModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, QuadrupedFrame {
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("boltund", "faint") else null
}