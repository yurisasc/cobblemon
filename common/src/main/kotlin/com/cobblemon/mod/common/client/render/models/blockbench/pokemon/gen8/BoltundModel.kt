...
class BoltundModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
    ...
    override fun registerPoses() {
        val blink = quirk("blink") { bedrockStateful("boltund", "blink") }
        sleep = registerPose(
    ...
    ) = if (state.isPosedIn(standing, walking, battleidle, sleep)) bedrockStateful("boltund", "faint") else null
}