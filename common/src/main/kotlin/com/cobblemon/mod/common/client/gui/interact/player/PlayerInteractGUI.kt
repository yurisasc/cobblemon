...
class PlayerInteractGUI(
    ...
    companion object {
        ...
        private val iconBattleResource = cobblemonResource("textures/gui/interact/icon_battle.png")
        private val iconTradeResource = cobblemonResource("textures/gui/interact/icon_trade.png")
    }
    ...
    fun isMouseInCenter(mouseX: Double, mouseY: Double): Boolean {
        ...
        return mouseX.toFloat() in (x.toFloat()..(x.toFloat() + 50)) && mouseY.toFloat() in (y.toFloat()..(y.toFloat() + 50))
    }
}