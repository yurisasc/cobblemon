...
class SneaselModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("sneasel", "cry") }
