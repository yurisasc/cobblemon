...
class DartrixHisuianModel(root: ModelPart) : PokemonPoseableModel(), BipedFrame, BiWingedFrame {
    override val rootPart = root.registerChildWithAllChildren("dartrix_hisuian")
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("dartrix_hisuian", "cry") }
    ...
    override fun registerPoses() {
        standing = registerPose(
                ...
                idleAnimations = arrayOf(
                        bedrock("dartrix_hisuian", "ground_idle")
                )
        )
        ...
        walk = registerPose(
                ...
                idleAnimations = arrayOf(
                        ...
                        //bedrock("dartrix_hisuian", "ground_walk")
                )
        )
    }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("dartrix_hisuian", "faint") else null
}