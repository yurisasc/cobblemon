...
class RodBaitComponent(val bait: FishingBait, val stack: ItemStack = ItemStack.EMPTY) {
    ...
    override fun hashCode() = bait.hashCode() * 31 + stack.hashCode()
    override fun equals(other: Any?) = other === this || (other is RodBaitComponent && other.bait == bait && ItemStack.isSameItemSameComponents(other.stack, stack))
}