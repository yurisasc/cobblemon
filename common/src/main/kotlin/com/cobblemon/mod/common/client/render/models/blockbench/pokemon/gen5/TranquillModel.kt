...
class TranquillModel (root: ModelPart) : PokemonPosableModel(root), HeadedFrame, BipedFrame, BiWingedFrame {
    override val rootPart = root.registerChildWithAllChildren("tranquill")
    ...
    override val cryAnimation = CryProvider { bedrockStateful("tranquill", "cry") }
