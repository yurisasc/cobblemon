...
class BattleChallengeNotificationPacket(
    ...
    companion object {
        ...
        fun decode(buffer: RegistryByteBuf) = BattleChallengeNotificationPacket(buffer.readUuid(), buffer.readUuid(), TextCodecs.PACKET_CODEC.decode(buffer).copy(), buffer.readString())
    }
}