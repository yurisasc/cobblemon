...
class MukModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame {
    ...
    override var profileTranslation = Vec3(-0.04, 0.44, 0.0)

    lateinit var standing: CobblemonPose
    lateinit var walk: CobblemonPose

    override val cryAnimation = CryProvider { bedrockStateful("muk", "cry") }
