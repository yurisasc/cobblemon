...
object CobblemonNetwork : NetworkManager {
    ...
    override fun registerClientBound() {
        ...
        this.createClientBound(OriginalTrainerUUIDUpdatePacket.ID, TradeableUpdatePacket::decode, PokemonUpdatePacketHandler())
        this.createClientBound(OriginalTrainerDisplayNameUpdatePacket.ID, TradeableUpdatePacket::decode, PokemonUpdatePacketHandler())
