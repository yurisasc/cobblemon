...
class OinkologneMaleModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, QuadrupedFrame {
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("oinkologne_male", "cry") }

    override fun registerPoses() {
//        sleep = registerPose(
//            poseType = PoseType.SLEEP,
//            idleAnimations = arrayOf(bedrock("oinkologne_male", "sleep"))
//        )
