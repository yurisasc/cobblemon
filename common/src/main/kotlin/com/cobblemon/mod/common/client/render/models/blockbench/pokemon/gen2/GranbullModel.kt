...
class GranbullModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("granbull", "cry").setPreventsIdle(false) }
