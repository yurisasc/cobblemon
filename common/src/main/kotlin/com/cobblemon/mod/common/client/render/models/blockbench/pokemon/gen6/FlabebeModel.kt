...
class FlabebeModel (root: ModelPart) : PokemonPosableModel(root), HeadedFrame {
    override val rootPart = root.registerChildWithAllChildren("flabebe")
    override val head = getPart("head")

    override var portraitScale = 2.26F
    override var portraitTranslation = Vec3(0.0, -0.14, 0.0)

    override var profileScale = 0.81F
    override var profileTranslation = Vec3(0.0, 0.63, 0.0)
