...
class TreeckoModel (root: ModelPart) : PosableModel(), HeadedFrame, BipedFrame {
    ...
    override fun getFaintAnimation(state: PosableState) = if (state.isNotPosedIn(sleep)) bedrockStateful("treecko", "faint") else null
}
