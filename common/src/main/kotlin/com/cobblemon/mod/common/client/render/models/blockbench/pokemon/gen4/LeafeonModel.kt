...
class LeafeonModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame {
    override val rootPart = root.registerChildWithAllChildren("leafeon")
    override val head = getPart("head")

    override var portraitScale = 2.3F
    override var portraitTranslation = Vec3(-0.7, -0.7, 0.0)
    ...
    override val cryAnimation = CryProvider { bedrockStateful("leafeon", "cry") }
