...
class TorchicModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame, BipedFrame {
    ...
    override var portraitTranslation = Vec3d(-0.1, -0.45, 0.0)
    ...
    override val cryAnimation = CryProvider { bedrockStateful("torchic", "cry") }
