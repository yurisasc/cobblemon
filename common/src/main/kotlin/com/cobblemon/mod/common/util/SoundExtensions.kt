 ...
 */
fun SoundManager.pauseSounds(id: ResourceLocation?, category: SoundCategory?) = (this as SoundManagerDuck).pauseSounds(id, category)
 ...
 * @param category The [SoundCategory] that [id] is queried from. If null, will query [id] from all categories.
 */
fun SoundManager.resumeSounds(id: ResourceLocation?, category: SoundCategory?) = (this as SoundManagerDuck).resumeSounds(id, category)
