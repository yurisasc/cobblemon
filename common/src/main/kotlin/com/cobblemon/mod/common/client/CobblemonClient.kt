...
//        ClientTaskTracker.update(partialDeltaTicks / 20f)
    ...
    fun reloadCodedAssets(resourceManager: ResourceManager) {
        ...
        BedrockAnimationRepository.loadAnimations(
            ...
            directories = PokemonModelRepository.animationDirectories + PokeBallModelRepository.animationDirectories + GenericBedrockModelRepository.animationDirectories + FossilModelRepository.animationDirectories
        )
