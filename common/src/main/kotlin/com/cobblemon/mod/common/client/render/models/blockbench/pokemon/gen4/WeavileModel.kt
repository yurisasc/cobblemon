...
class WeavileModel (root: ModelPart) : PosableModel(root), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override val cryAnimation = CryProvider { bedrockStateful("weavile", "cry") }
