...
class MeowthGalarianModel(root: ModelPart) : PosableModel(), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override fun getFaintAnimation(state: PosableState) = bedrockStateful("meowth_galarian", "faint")
}