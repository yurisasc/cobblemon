...
class CombuskenModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame, BipedFrame {
    ...
    override var portraitTranslation = Vec3(0.0, 0.3, 0.0)
    ...
    override val cryAnimation = CryProvider { bedrockStateful("combusken", "cry") }
