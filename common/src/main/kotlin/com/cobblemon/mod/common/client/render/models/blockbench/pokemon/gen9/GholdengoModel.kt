...
class GholdengoModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override fun registerPoses() {
        val blink = quirk("blink") { bedrockStateful("gholdengo", "blink").setPreventsIdle(false) }
