...
class MudkipModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame, QuadrupedFrame {
    ...
    override var portraitTranslation = Vec3(-0.25, -1.2, 0.0)
    ...
    override val cryAnimation = CryProvider { bedrockStateful("mudkip", "cry") }
