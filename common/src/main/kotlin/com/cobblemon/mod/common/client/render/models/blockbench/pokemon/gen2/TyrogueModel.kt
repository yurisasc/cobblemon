...
class TyrogueModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("tyrogue", "faint") else null
}