...
class PorygonzModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
    ...
    override fun registerPoses() {
        ...
        val twitch1 = quirk("twitch1") { bedrockStateful("porygonz", "twitch1") }
        val twitch2 = quirk("twitch2") { bedrockStateful("porygonz", "twitch2") }
        val twitch3 = quirk("twitch3") { bedrockStateful("porygonz", "twitch3") }
        val twitch4 = quirk("twitch4") { bedrockStateful("porygonz", "twitch4") }
        val twitch5 = quirk("twitch5") { bedrockStateful("porygonz", "twitch5") }
        val twitch6 = quirk("twitch6") { bedrockStateful("porygonz", "twitch6") }
        sleep = registerPose(
