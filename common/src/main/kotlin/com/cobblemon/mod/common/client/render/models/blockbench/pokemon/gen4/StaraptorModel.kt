...
class StaraptorModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BiWingedFrame {
...
//    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("staraptor", "cry").setPreventsIdle(false) }
