...
class LopunnyModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame {
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("lopunny", "cry").setPreventsIdle(false) }
