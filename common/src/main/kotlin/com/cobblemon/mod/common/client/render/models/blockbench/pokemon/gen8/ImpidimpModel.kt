...
class ImpidimpModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("impidimp", "cry") }

    override fun registerPoses() {
        val blink = quirk { bedrockStateful("impidimp", "blink") }
