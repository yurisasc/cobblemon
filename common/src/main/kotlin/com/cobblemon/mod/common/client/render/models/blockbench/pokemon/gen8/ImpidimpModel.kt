...
class ImpidimpModel (root: ModelPart) : PosableModel(root), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override val cryAnimation = CryProvider { bedrockStateful("impidimp", "cry") }
