...
class OshawottHisuianModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("oshawott", "hisuian_cry") }
