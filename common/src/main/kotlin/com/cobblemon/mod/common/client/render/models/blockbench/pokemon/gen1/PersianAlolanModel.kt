...
class PersianAlolanModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame, QuadrupedFrame {
    ...
    override val portraitTranslation = Vec3d(-0.76, -0.11, 0.0)
    ...
    override fun registerPoses() {
        val blink = quirk("blink") { bedrockStateful("persian_alolan", "blink").setPreventsIdle(false)}
        ...
        sleep = registerPose(
                ...
                idleAnimations = arrayOf(bedrock("persian_alolan", "sleep"))
        )
