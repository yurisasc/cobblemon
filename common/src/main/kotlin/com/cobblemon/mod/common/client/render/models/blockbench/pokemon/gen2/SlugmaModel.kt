...
class SlugmaModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
    ...
    override fun registerPoses() {
        val blink = quirk("blink") { bedrockStateful("slugma", "blink") }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("slugma", "faint") else null
}