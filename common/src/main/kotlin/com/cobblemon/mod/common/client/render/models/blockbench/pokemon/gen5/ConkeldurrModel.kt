...
class ConkeldurrModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame {
    ...
    override fun registerPoses() {
        val blink = quirk("blink") { bedrockStateful("conkeldurr", "blink").setPreventsIdle(false) }
