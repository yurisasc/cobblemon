...
class FlaaffyModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame {
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("flaaffy", "faint") else null
}