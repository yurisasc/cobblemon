...
class MiltankModel (root: ModelPart) : PokemonPosableModel(root), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override var portraitTranslation = Vec3(-0.21, 1.1, 0.0)
    ...
    override val cryAnimation = CryProvider { bedrockStateful("miltank", "cry") }
