...
class GlaceonModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame {
    override val rootPart = root.registerChildWithAllChildren("glaceon")
    override val head = getPart("head")

    override var portraitScale = 2.4F
    override var portraitTranslation = Vec3(-0.7, -0.75, 0.0)
    ...
    override val cryAnimation = CryProvider { bedrockStateful("glaceon", "cry") }
