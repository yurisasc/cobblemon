...
class ShieldonModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, QuadrupedFrame {
    ...
    override val portraitTranslation = Vec3d(-0.45, -0.9, 0.0)
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("shieldon", "faint") else null
}