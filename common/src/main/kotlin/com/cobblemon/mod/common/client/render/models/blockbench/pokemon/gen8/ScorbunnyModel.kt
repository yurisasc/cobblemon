...
class ScorbunnyModel (root: ModelPart) : PokemonPosableModel(root), HeadedFrame, BipedFrame, BimanualFrame {
...
//    lateinit var sleep: Pose
    ...
    override val cryAnimation = CryProvider { bedrockStateful("scorbunny", "cry") }
