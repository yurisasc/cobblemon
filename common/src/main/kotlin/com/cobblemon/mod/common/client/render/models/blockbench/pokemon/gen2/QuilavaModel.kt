...
class QuilavaModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("quilava", "cry").setPreventsIdle(false) }
