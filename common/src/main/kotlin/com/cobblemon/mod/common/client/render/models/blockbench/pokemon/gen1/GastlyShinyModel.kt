...
class GastlyShinyModel(root: ModelPart) : PokemonPoseableModel() {
    ...
    override fun registerPoses() {
        val blink = quirk(name = "blink") { bedrockStateful("gastly_shiny", "blink") }

        sleep = registerPose(
            poseType = PoseType.SLEEP,
            idleAnimations = arrayOf(bedrock("gastly_shiny", "sleep"))
        )
