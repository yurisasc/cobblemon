...
class GalladeModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("gallade", "cry").setPreventsIdle(false) }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("gallade", "faint") else null
}