...
class NidorinoModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
...
//        val blink = quirk("blink") { bedrockStateful("nidorino", "blink").setPreventsIdle(false)}
...
//            quirks = arrayOf(blink),
        ...
        sleep = registerPose(
                ...
                idleAnimations = arrayOf(bedrock("nidorino", "sleep"))
        )
