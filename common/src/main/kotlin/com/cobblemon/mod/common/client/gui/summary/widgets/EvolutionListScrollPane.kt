...
import com.cobblemon.mod.common.client.gui.summary.widgets.common.ModelSectionScrollPane
...
class EvolutionListScrollPane(private val pokemon: Pokemon) : ModelSectionScrollPane<EvolutionListScrollPane.EvolutionOption>(
    ...
    companion object {
        ...
        private val OVERLAY_RESOURCE = cobblemonResource("ui/summary/summary_moves_change.png")

        // Entry
        private val SINGLE_TYPE_ENTRY_RESOURCE = cobblemonResource("ui/summary/summary_info_evolve_slot1.png")
        private val DUAL_TYPE_ENTRY_RESOURCE = cobblemonResource("ui/summary/summary_info_evolve_slot2.png")
        ...
        // Confirmation button
        private val BUTTON_RESOURCE = cobblemonResource("ui/summary/summary_info_evolve_slot_button.png")
        ...
        // Type preview
        private val TYPE_CHART_RESOURCE = cobblemonResource("ui/types.png")
        ...
        // Model preview
        private val MODEL_UNDERLAY_RESOURCE = cobblemonResource("ui/summary/summary_info_evolve_underlay.png")
