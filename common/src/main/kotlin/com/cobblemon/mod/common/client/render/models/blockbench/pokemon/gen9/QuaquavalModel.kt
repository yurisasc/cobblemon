...
class QuaquavalModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame {
    ...
    override val portraitTranslation = Vec3d(-0.3, 4.0, 0.0)
    ...
    override fun registerPoses() {
        val blink = quirk("blink") { bedrockStateful("quaquaval", "blink").setPreventsIdle(false) }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("quaquaval", "faint") else null
}