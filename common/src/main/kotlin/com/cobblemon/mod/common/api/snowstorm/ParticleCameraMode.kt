 ...
 * - Sets the particle Y axis to that which is as close to parallel to the camera plane as
 *   possible while still being perpendicular to that X axis.
 *
 * The second requirement is hard to understand. The way it was eventually solved is by
 ...
 *
 * That plane slices right through the camera, and so the normal vector of that plane is
 * the most visible Y axis while also being perpendicular to the X axis like a Y axis should.
 *
