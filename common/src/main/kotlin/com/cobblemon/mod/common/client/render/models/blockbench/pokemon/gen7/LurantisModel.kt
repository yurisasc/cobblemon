...
class LurantisModel (root: ModelPart) : PosableModel(root), HeadedFrame, BipedFrame, BimanualFrame {
    ...
    override val cryAnimation = CryProvider { bedrockStateful("lurantis", "cry") }
