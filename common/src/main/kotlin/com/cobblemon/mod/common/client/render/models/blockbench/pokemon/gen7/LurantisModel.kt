...
class LurantisModel (root: ModelPart) : PokemonPoseableModel(), HeadedFrame, BipedFrame, BimanualFrame {
...
//    override val cryAnimation = CryProvider { _, _ -> bedrockStateful("lurantis", "cry") }

    override fun registerPoses() {
        val blink = quirk { bedrockStateful("lurantis", "blink") }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("lurantis", "faint") else null
}