...
object CobblemonGameRules {
    ...
    @JvmField
    val WEATHER_AFFECTS_BATTLES: GameRules.Key<GameRules.BooleanRule> = Cobblemon.implementation.registerGameRule("weatherAffectsBattles", GameRules.Category.MISC, BooleanRuleInvoker.`cobblemon$create`(true))
