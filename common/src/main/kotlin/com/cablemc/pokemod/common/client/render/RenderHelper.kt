...
package com.cablemc.pokemod.common.client.render

import com.cablemc.pokemod.common.api.gui.drawText
...
fun renderBeaconBeam(
    ...
    textureLocation: Identifier = PokemodResources.PHASE_BEAM,
    partialTicks: Float,
    totalLevelTime: Long,
    yOffset: Float = 0F,
    height: Float,
