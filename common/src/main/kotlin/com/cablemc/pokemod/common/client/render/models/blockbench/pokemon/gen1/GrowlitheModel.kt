...
class GrowlitheModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("0058_growlithe/growlithe", "faint") else null
}