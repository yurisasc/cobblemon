...
//        blitk(matrices, CobbledResources.RED, 0, 0, 1000, 1000)
    ...
    companion object {
        ...
        private val PARTY_START_TEXTURE = pokemodResource("ui/summary/summary_party_1.png")
        private val PARTY_END_TEXTURE = pokemodResource("ui/summary/summary_party_2.png")
        private val PARTY_SURROUNDED_TEXTURE = pokemodResource("ui/summary/summary_party_2-5.png")
        private val PARTY_SIX_TEXTURE = pokemodResource("ui/summary/summary_party_6.png")

        // Selected member
        private val SELECTED_TEXTURE = pokemodResource("ui/summary/summary_overlay_party.png")
