...
package com.cablemc.pokemod.common.client.gui.battle.widgets

import com.cablemc.pokemod.common.api.gui.blitk
import com.cablemc.pokemod.common.api.text.text
import com.cablemc.pokemod.common.client.battle.ClientBattleMessageQueue
...
class BattleMessagePane(
    ...
    companion object {
        ...
        private val battleMessagePaneFrameResource = pokemodResource("ui/battle/battle_log.png")
        private val battleMessagePaneFrameExpandedResource = pokemodResource("ui/battle/battle_log_expanded.png")
