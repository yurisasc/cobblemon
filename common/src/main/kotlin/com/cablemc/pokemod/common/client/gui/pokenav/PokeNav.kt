...
package com.cablemc.pokemod.common.client.gui.pokenav
...
class PokeNav : Screen(Text.translatable("pokemod.ui.pokenav.title")) {
    ...
    companion object {
        ...
        // Textures
        private val background = pokemodResource("ui/pokenav/pokenav_base.png")
        private val exit = pokemodResource("ui/pokenav/pokenav_exit.png")
        private val pokemon = pokemodResource("ui/pokenav/pokenav_pokemon.png")
        private val select = pokemodResource("ui/pokenav/pokenav_select.png")
    }
    ...
    override fun init() {
        this.buttons.clear()
        // Pokemon Button
        this.insertButton(pokemon, this::onPressPokemon, lang("ui.pokemon")) { PokemodClient.storage.myParty.slots.filterNotNull().isNotEmpty() }
    ...
    override fun keyPressed(pKeyCode: Int, pScanCode: Int, pModifiers: Int): Boolean {
        val movement: Pair<Int, Int> = when (pKeyCode) {
            ...
            PokeNavigatorBinding.currentKey().code, InputUtil.GLFW_KEY_LEFT_SHIFT, InputUtil.GLFW_KEY_RIGHT_SHIFT -> {
