...
object PokemodPlacements {
    ...
    fun register() {
        BLACK_APRICORN_TREE = PlacedFeatures.register("black_apricorn_tree", PokemodConfiguredFeatures.BLACK_APRICORN_TREE, PlacedFeatures.wouldSurvive(
            PokemodBlocks.BLACK_APRICORN_SAPLING.get()))
        BLUE_APRICORN_TREE = PlacedFeatures.register("blue_apricorn_tree", PokemodConfiguredFeatures.BLUE_APRICORN_TREE, PlacedFeatures.wouldSurvive(
            PokemodBlocks.BLUE_APRICORN_SAPLING.get()))
        GREEN_APRICORN_TREE = PlacedFeatures.register("green_apricorn_tree", PokemodConfiguredFeatures.GREEN_APRICORN_TREE, PlacedFeatures.wouldSurvive(
            PokemodBlocks.GREEN_APRICORN_SAPLING.get()))
        PINK_APRICORN_TREE = PlacedFeatures.register("pink_apricorn_tree", PokemodConfiguredFeatures.PINK_APRICORN_TREE, PlacedFeatures.wouldSurvive(
            PokemodBlocks.PINK_APRICORN_SAPLING.get()))
        RED_APRICORN_TREE = PlacedFeatures.register("red_apricorn_tree", PokemodConfiguredFeatures.RED_APRICORN_TREE, PlacedFeatures.wouldSurvive(
            PokemodBlocks.RED_APRICORN_SAPLING.get()))
        WHITE_APRICORN_TREE = PlacedFeatures.register("white_apricorn_tree", PokemodConfiguredFeatures.WHITE_APRICORN_TREE, PlacedFeatures.wouldSurvive(
            PokemodBlocks.WHITE_APRICORN_SAPLING.get()))
        YELLOW_APRICORN_TREE = PlacedFeatures.register("yellow_apricorn_tree", PokemodConfiguredFeatures.YELLOW_APRICORN_TREE, PlacedFeatures.wouldSurvive(
