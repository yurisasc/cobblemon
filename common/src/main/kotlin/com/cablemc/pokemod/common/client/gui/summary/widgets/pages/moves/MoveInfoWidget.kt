...
class MoveInfoWidget(
    ...
    companion object {
        private val powerText = Text.translatable("pokemod.ui.power")
        private val accuracyText = Text.translatable("pokemod.ui.accuracy")
        private val effectText = Text.translatable("pokemod.ui.effect")
