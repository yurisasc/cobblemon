...
import com.cablemc.pokemod.common.client.render.models.blockbench.TexturedModel
...
import com.cablemc.pokemod.common.util.adapters.Vec3fAdapter
import com.cablemc.pokemod.common.util.adapters.Vector4fAdapter
...
/*
{
  "poser": "pokemod:squirtle",
  "model": "pokemod:bedrock/models/squirtle.geo.json",
  "texture": "pokemod:textures/pokemon/squirtle.png",
  "variations": [
    {
      "aspects": ["shiny"],
      "texture": "pokemod:textures/pokemon/squirtle_shiny.png"
    },
    {
      "aspects": ["sunglasses"],
      "layers": [
        {
          "name": "sunnies",
          "texture": "pokemod:textures/pokemon/squirtle_sunglasses.png",
          "scale": [1.05, 1, 1.05],
          "tint": [1, 0.1, 0.1, 0.6]
        }
      ]
