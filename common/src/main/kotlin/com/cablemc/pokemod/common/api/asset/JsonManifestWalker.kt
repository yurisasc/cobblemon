...
package com.cablemc.pokemod.common.api.asset
...
object JsonManifestWalker {
    ...
    fun <T> load(clazz: Class<T>, folder: String, gson: Gson): List<T> {
        val manifestPath = "/assets/${Pokemod.MODID}/$folder/_MANIFEST.json"
        val manifest = Pokemod::class.java.getResourceAsStream(manifestPath)!!
        ...
        array.forEach {
            ...
            val stream = Pokemod.javaClass.getResourceAsStream("$folderPath/$path") ?: run {
