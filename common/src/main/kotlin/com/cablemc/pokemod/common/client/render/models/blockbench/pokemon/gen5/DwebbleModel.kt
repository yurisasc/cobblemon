...
class DwebbleModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
    override val rootPart = root.registerChildWithAllChildren("dwebble")
    override val head = getPart("head")

    override val portraitScale = 1.5F
    override val portraitTranslation = Vec3d(0.0, -.65, 0.0)
    ...
    override fun registerPoses() {
        standing = registerPose(
            ...
            idleAnimations = arrayOf(
                singleBoneLook(),
                bedrock("0557_dwebble/dwebble", "ground_idle")
            )
        )
        ...
        walk = registerPose(
            ...
            idleAnimations = arrayOf(
                singleBoneLook(),
                bedrock("0557_dwebble/dwebble", "ground_idle")
                //bedrock("0557_dwebble/dwebble", "ground_walk")
            )
        )
    }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("0557_dwebble/dwebble", "faint") else null
}