...
object PokeBallModelRepository : ModelRepository<EmptyPokeBallEntity>() {
    ...
    override fun registerAll() {
        ...
        registerModelTexture(PokeBalls.POKE_BALL, pokemodResource("textures/items/poke_balls/models/poke_ball.png"))
        registerModelTexture(PokeBalls.VERDANT_BALL, pokemodResource("textures/items/poke_balls/models/verdant_ball.png"))
        registerModelTexture(PokeBalls.SPORT_BALL, pokemodResource("textures/items/poke_balls/models/sport_ball.png"))
        registerModelTexture(PokeBalls.SLATE_BALL, pokemodResource("textures/items/poke_balls/models/slate_ball.png"))
        registerModelTexture(PokeBalls.AZURE_BALL, pokemodResource("textures/items/poke_balls/models/azure_ball.png"))
        registerModelTexture(PokeBalls.CITRINE_BALL, pokemodResource("textures/items/poke_balls/models/citrine_ball.png"))
        registerModelTexture(PokeBalls.ROSEATE_BALL, pokemodResource("textures/items/poke_balls/models/roseate_ball.png"))
        registerModelTexture(PokeBalls.GREAT_BALL, pokemodResource("textures/items/poke_balls/models/great_ball.png"))
        registerModelTexture(PokeBalls.ULTRA_BALL, pokemodResource("textures/items/poke_balls/models/ultra_ball.png"))
        registerModelTexture(PokeBalls.MASTER_BALL, pokemodResource("textures/items/poke_balls/models/master_ball.png"))
    }
