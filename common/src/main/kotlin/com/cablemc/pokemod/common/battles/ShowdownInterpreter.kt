...
import com.cablemc.pokemod.common.battles.dispatch.UntilDispatch
import com.cablemc.pokemod.common.battles.dispatch.WaitDispatch
...
import com.cablemc.pokemod.common.util.swap
    ...
    private fun handleTurnInstruction(battle: PokemonBattle, message: String, remainingLines: MutableList<String>) {
        if (!battle.started) {
            ...
            if (players.isNotEmpty()) {
                ...
                players.forEach { PokemodNetwork.sendToPlayer(it, initializePacket) }
            }
