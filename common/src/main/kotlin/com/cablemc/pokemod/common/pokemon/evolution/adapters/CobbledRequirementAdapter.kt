...
import com.cablemc.pokemod.common.api.pokemon.evolution.adapters.RequirementAdapter
import com.cablemc.pokemod.common.api.pokemon.evolution.requirement.EvolutionRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.AreaRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.AttackDefenceRatioRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.BattleCriticalHitsRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.BiomeRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.DamageTakenRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.FriendshipRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.HeldItemRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.LevelRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.MoveSetRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.MoveTypeRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.PartyMemberRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.PokemonPropertiesRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.TimeRangeRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.WeatherRequirement
import com.cablemc.pokemod.common.pokemon.evolution.requirements.WorldRequirement
