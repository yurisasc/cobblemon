...
package com.cablemc.pokemod.common.pokemon.activestate
...
class SentOutState() : ActivePokemonState() {
    ...
    override val entity: PokemonEntity?
        get() = Pokemod.getLevel(dimension)?.getEntityById(entityId) as? PokemonEntity
    ...
    override fun getIcon(pokemon: Pokemon) = pokemodResource("ui/party/party_icon_released.png")
    override fun writeToNBT(nbt: NbtCompound) = null
...
class ShoulderedState() : ActivePokemonState() {
    ...
    override fun getIcon(pokemon: Pokemon): Identifier {
        ...
        return pokemodResource("ui/party/party_icon_shoulder_$suffix.png")
    }
