...
import com.cablemc.pokemod.common.api.storage.adapter.SerializedStore
...
import com.cablemc.pokemod.common.util.subscribeOnServer
...
open class FileBackedPokemonStoreFactory<S>(
    ...
    var passedTicks = 0
    protected val saveSubscription = PokemodEvents.TICK_PRE.subscribe {
        passedTicks++
        if (passedTicks > 20 * Pokemod.config.pokemonSaveIntervalSeconds) {
            saveAll()
            passedTicks = 0
        }
    }
