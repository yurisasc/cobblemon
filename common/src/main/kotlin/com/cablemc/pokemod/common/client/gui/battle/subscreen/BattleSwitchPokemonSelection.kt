...
import com.cablemc.pokemod.common.battles.ShowdownPokemon
...
class BattleSwitchPokemonSelection(
    ...
    class SwitchTile(
        ...
        fun render(matrices: MatrixStack, mouseX: Double, mouseY: Double, deltaTicks: Float) {
            PokemodClient.battleOverlay.drawBattleTile(
                matrices = matrices,
                x = x,
                y = y,
                reversed = false,
    ...
    init {
        val pendingActionRequests = PokemodClient.battle!!.pendingActionRequests
