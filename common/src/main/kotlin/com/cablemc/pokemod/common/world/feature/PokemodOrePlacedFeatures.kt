...
import com.cablemc.pokemod.common.tags.PokemodBiomeTags
...
object PokemodOrePlacedFeatures {
    ...
    // Dawn Stone
    private val DAWN_STONES = this.createOreFeatures("ore_dawn_stone", PokemodOreConfiguredFeatures.ORE_DAWN_STONE, PokemodBiomeTags.HAS_DAWN_STONE_ORE, PokemodBiomeTags.HAS_DAWN_STONE_ORE_RARE)
    ...
    // Dusk Stone
    private val DUSK_STONES = this.createOreFeatures("ore_dusk_stone", PokemodOreConfiguredFeatures.ORE_DUSK_STONE, PokemodBiomeTags.HAS_DUSK_STONE_ORE, PokemodBiomeTags.HAS_DUSK_STONE_ORE_RARE)
    ...
    // Fire Stone
    private val FIRE_STONES = this.createOreFeatures("ore_fire_stone", PokemodOreConfiguredFeatures.ORE_FIRE_STONE, PokemodBiomeTags.HAS_FIRE_STONE_ORE, PokemodBiomeTags.HAS_FIRE_STONE_ORE_RARE)
    ...
    // Ice Stone
    private val ICE_STONES = this.createOreFeatures("ore_ice_stone", PokemodOreConfiguredFeatures.ORE_ICE_STONE, PokemodBiomeTags.HAS_ICE_STONE_ORE, PokemodBiomeTags.HAS_ICE_STONE_ORE_RARE)
    ...
    // Leaf Stone
    private val LEAF_STONES = this.createOreFeatures("ore_leaf_stone", PokemodOreConfiguredFeatures.ORE_LEAF_STONE, PokemodBiomeTags.HAS_LEAF_STONE_ORE, PokemodBiomeTags.HAS_LEAF_STONE_ORE_RARE)
    ...
    // Moon Stone
    private val MOON_STONES = this.createOreFeatures("ore_moon_stone", PokemodOreConfiguredFeatures.ORE_MOON_STONE, PokemodBiomeTags.HAS_MOON_STONE_ORE, PokemodBiomeTags.HAS_MOON_STONE_ORE_RARE)
    ...
    val MOON_STONE_DRIPSTONE = this.createFeature("ore_moon_stone_dripstone", PokemodOreConfiguredFeatures.ORE_MOON_STONE_DRIPSTONE, { it.hasTag(PokemodBiomeTags.HAS_MOON_STONE_ORE_DRIPSTONE) }, CountPlacementModifier.of(256), SquarePlacementModifier.of(), DRIPSTONE_RANGE, BiomePlacementModifier.of())

    // Shiny Stone
    private val SHINY_STONES = this.createOreFeatures("ore_shiny_stone", PokemodOreConfiguredFeatures.ORE_SHINY_STONE, PokemodBiomeTags.HAS_SHINY_STONE_ORE, PokemodBiomeTags.HAS_SHINY_STONE_ORE_RARE)
    ...
    // Sun Stone
    private val SUN_STONES = this.createOreFeatures("ore_sun_stone", PokemodOreConfiguredFeatures.ORE_SUN_STONE, PokemodBiomeTags.HAS_SUN_STONE_ORE, PokemodBiomeTags.HAS_SUN_STONE_ORE_RARE)
    ...
    // Thunder Stone
    private val THUNDER_STONES = this.createOreFeatures("ore_thunder_stone", PokemodOreConfiguredFeatures.ORE_THUNDER_STONE, PokemodBiomeTags.HAS_THUNDER_STONE_ORE, PokemodBiomeTags.HAS_THUNDER_STONE_ORE_RARE)
    ...
    // Water Stone
    private val WATER_STONES = this.createOreFeatures("ore_water_stone", PokemodOreConfiguredFeatures.ORE_WATER_STONE, PokemodBiomeTags.HAS_WATER_STONE_ORE, PokemodBiomeTags.HAS_WATER_STONE_ORE_RARE)
    ...
    private fun createFeature(name: String, registryEntry: RegistryEntry<ConfiguredFeature<OreFeatureConfig, *>>, condition: (context: BiomeModifications.BiomeContext) -> Boolean, vararg modifiers: PlacementModifier): RegistryEntry<PlacedFeature> {
        val feature = PlacedFeatures.register(pokemodResource(name).toString(), registryEntry, *modifiers)
