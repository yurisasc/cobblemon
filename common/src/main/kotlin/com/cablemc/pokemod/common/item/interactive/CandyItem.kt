...
import com.cablemc.pokemod.common.api.pokemon.experience.CandyExperienceSource
import com.cablemc.pokemod.common.entity.pokemon.PokemonEntity
import com.cablemc.pokemod.common.item.PokemodItemGroups
import com.cablemc.pokemod.common.item.interactive.CandyItem.Calculator
...
class CandyItem(
...
) : PokemonInteractiveItem(Settings().group(PokemodItemGroups.MEDICINE_ITEM_GROUP), Ownership.OWNER) {
    ...
    override fun processInteraction(player: ServerPlayerEntity, entity: PokemonEntity, stack: ItemStack): Boolean {
        ...
        PokemodEvents.EXPERIENCE_CANDY_USE_PRE.postThen(
