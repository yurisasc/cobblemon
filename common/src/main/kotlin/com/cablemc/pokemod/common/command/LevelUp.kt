...
import com.cablemc.pokemod.common.api.pokemon.experience.CommandExperienceSource
...
object LevelUp {
    ...
    fun register(dispatcher : CommandDispatcher<ServerCommandSource>) {
        val command = CommandManager.literal("levelup")
            .permission(PokemodPermissions.LEVEL_UP_SELF)
            .permissionLevel(PermissionLevel.CHEAT_COMMANDS_AND_COMMAND_BLOCKS)
            .then(
                CommandManager.argument("player", EntityArgumentType.player())
                    .permission(PokemodPermissions.LEVEL_UP_OTHER)
