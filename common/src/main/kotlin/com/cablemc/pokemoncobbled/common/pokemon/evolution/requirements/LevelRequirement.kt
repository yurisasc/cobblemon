...
/**
 * A [PositionQueryRequirement] for when a [Pokemon] is expected to be in a [Level].
 *
 * @property resourceLocation The [ResourceLocation] of the [Level] the queried entity is expected to be in.
 * @author Licious
 * @since March 21st, 2022
 */
class LevelRequirement(val resourceLocation: ResourceLocation) : PositionQueryRequirement() {
