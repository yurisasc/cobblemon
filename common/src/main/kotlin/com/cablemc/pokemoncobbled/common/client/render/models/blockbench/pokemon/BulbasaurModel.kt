...
class BulbasaurModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame, QuadrupedFrame {
    override val rootPart = root.registerChildWithSpecificChildren("bulbasaur", listOf("head","bulb","body","leg_front_right","leg_front_left","leg_hind_right","leg_hind_left"))
