...
class MagmortarModel(root: ModelPart) : PokemonPoseableModel(), HeadedFrame {
    ...
    override fun registerPoses() {
        standing = registerPose(
            ...
            idleAnimations = arrayOf(
                singleBoneLook()
                // bedrock("0467_magmortar/magmortar", "ground_idle")
            )
        )
        ...
        walk = registerPose(
            ...
            idleAnimations = arrayOf(
                singleBoneLook()
                // bedrock("0467_magmortar/magmortar", "ground_walk")
            )
        )
    }
...
//    ) = if (state.isPosedIn(standing, walk)) bedrockStateful("0467_magmortar/magmortar", "faint") else null
}