...
object CobbledBlockEntities {
    private val registry = DeferredRegister.create(PokemonCobbled.MODID, Registry.BLOCK_ENTITY_TYPE_REGISTRY)
    ...
    val HEALING_MACHINE = register("healing_machine") { BlockEntityType.Builder.of(::HealingMachineBlockEntity, CobbledBlocks.HEALING_MACHINE.get()).build(null) }
}