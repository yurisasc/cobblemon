...
object BedrockAnimationRepository {
    ...
    fun loadAnimationsFromFile(fileName: String) {
        val stream = javaClass.getResourceAsStream("/assets/${PokemonCobbled.MODID}/animations/$fileName") ?: throw IllegalStateException("animation file $fileName could not be found")
