...
import com.cablemc.pokemoncobbled.common.api.spawning.context.calculators.RegionSpawningContextCalculator
import com.cablemc.pokemoncobbled.common.api.spawning.context.calculators.RegionSpawningInput
 ...
 * as one of the context calculators returns true for [RegionSpawningContextCalculator.fits],
 ...
 */
interface RegionContextResolver {
    fun resolve(
        spawner: Spawner,
        contextCalculators: List<RegionSpawningContextCalculator<*>>,
        slice: WorldSlice
    ): List<RegionSpawningContext> {
        val pos = BlockPos.MutableBlockPos(1, 2, 3)
        val input = RegionSpawningInput(pos, slice)
        val contexts = mutableListOf<RegionSpawningContext>()
