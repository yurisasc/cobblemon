...
import com.cablemc.pokemoncobbled.common.entity.pokeball.PokeBallDelegate

class EmptyPokeBallClientDelegate : PoseableEntityState<EmptyPokeBallEntity>(), PokeBallDelegate<EmptyPokeBallEntity> {
