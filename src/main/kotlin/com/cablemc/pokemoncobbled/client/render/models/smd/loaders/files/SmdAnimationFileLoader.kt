...
import com.cablemc.pokemoncobbled.client.render.models.smd.loaders.files.schemas.SmdAnimationFrameSchema
import com.cablemc.pokemoncobbled.client.render.models.smd.loaders.files.schemas.SmdAnimationSchema
import com.cablemc.pokemoncobbled.client.render.models.smd.loaders.files.schemas.SmdBoneTransformationSchema
...
class SmdAnimationFileLoader {
    ...
    fun load(location: ResourceLocation): SmdAnimationSchema {
        ...
        val builder = SmdAnimationSchemaBuilder()
        val lineIndex = 0
