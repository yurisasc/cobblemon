...
import com.cablemc.pokemoncobbled.client.render.models.blockbench.frame.*
        ...
        fun createBodyLayer(): LayerDefinition {
            ...
            val head_r1 = head.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(21, 5)
                    .addBox(-2.5f, 0.0f, 0.0f, 5.0f, 0.0f, 5.0f, CubeDeformation(0.0f)),
            ...
            val tail = body.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(13, 0)
                    .addBox(-3.0f, 0.0f, 0.0f, 6.0f, 0.0f, 5.0f, CubeDeformation(0.0f)),
            ...
            val leftwing = body.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(0, 5)
                    .addBox(0.0f, -2.5f, 0.0f, 0.0f, 5.0f, 8.0f, CubeDeformation(0.0f)),
