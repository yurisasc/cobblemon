...
object NeoForgePermissionValidator : PermissionValidator {
    ...
    override fun initialize() {
        Cobblemon.LOGGER.info("Booting {}, player permissions will be checked using {}' PermissionAPI, non player command sources will use Minecraft' permission level system, see https://docs.neoforged.net/docs/gettingstarted/ and https://minecraft.fandom.com/wiki/Permission_level", this::class.simpleName, NeoForge::class.simpleName)
    }
